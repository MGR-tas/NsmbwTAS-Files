...
**BEFORE USING SCRIPTS**:    Disable panic handlers in Dolphin's Config -> Interface. This is necessary to avoid randomly having dolphin overload you with a ton of "Unable to resolve read address..." errors for no reason.
